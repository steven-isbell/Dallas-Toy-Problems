...
/*  Today you're problem is inappropriate language in user posts. You're
        tasked with cleaning up the language for each post in the posts
        data collection

    The Goal:
        * For each post in the posts array, change each occurence of the following
            words to '*' where each star is a letter in the word being replaced.
            (e.g. 'butt' => '****', 'freaking' => '********', and so on).
        * Words To Filter For
            * butt
            * crap
            * shoot
            ...
            * freaking
            * flipping
        * You're functionality should return an array of objects with text properties
           that have had the language cleaned up
*/
